            ...
            <div className="relative w-full min-h-125 md:h-130 rounded-3xl overflow-hidden flex items-center shadow-lg py-[65.5px]">
                ...
                <div className="relative z-10 p-8 md:p-16 flex flex-col items-start max-w-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
                        <Link
                            href="/register"
                            className="flex items-center justify-center px-8 pt-[16.5px] pb-[17.5px] bg-[#1B7575] text-white text-[16px] font-medium rounded-xl hover:bg-[#1B7575]/90 transition-colors shadow-md"
                        >
                            今すぐ始める
                        </Link>
                        <Link
                            href="/community"
                            className="flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur border border-white/20 text-white text-[16px] font-medium rounded-xl hover:bg-white/20 transition-colors"
                        >
                            詳しく見る
                        </Link>
                    </div>
