...
export default function Header() {
    return (
        <header className="fixed top-0 left-0 right-0 z-50 w-full h-18 bg-[#134E4A]/70 backdrop-blur-md border-b border-white/10">
            <div className="mx-auto px-6 h-full flex items-center justify-between">
                <div className="flex items-center gap-16.5">
                    <Link href="/" className="flex flex-col items-start relative h-9.75 justify-center">
                        <span className="text-[20px] font-bold tracking-[-0.5px] text-white leading-7" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                            Tomoio
                        </span>
                        <span className="text-[10px] font-medium tracking-[1px] uppercase text-[#99F6E4]/70 whitespace-nowrap leading-2.75" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                            CULTURAL BRIDGE
                        </span>
                    </Link>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link
                        href="/register"
                        className="flex items-center justify-center px-5 py-2 h-9 bg-[#1B7575] text-white font-medium rounded-lg hover:bg-[#134E4A] transition-colors shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-4px_rgba(0,0,0,0.1)] relative isolation-auto"    
                    >
                        新規登録
                    </Link>
                </div>
