    ...
    const navLinks = [
        {
            ...
            path: "/matching",
            icon: (
                <svg className="transition-transform duration-300 group-hover:scale-110" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            path: "/community",
            icon: (
                <svg className="transition-transform duration-300 group-hover:scale-110" width="24" height="12" viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            path: "/chat",
            icon: (
                <svg className="transition-transform duration-300 group-hover:scale-110" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 20V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H18C18.55 0 19.0208 0.195833 19.4125 0.5875C19.8042 0.979167 20 1.45 20 2V14C20 14.55 19.8042 15.0208 19.4125 15.4125C19.0208 15.8042 18.55 16 18 16H4L0 20ZM3.15 14H18V2H2V15.125L3.15 14ZM2 14V2V14Z" fill="currentColor" />
                </svg>
            ),
        },
        {
            ...
            path: "/profile",
            icon: (
                <svg className="transition-transform duration-300 group-hover:scale-110" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <aside className="w-64 h-screen sticky top-0 bg-gradient-to-b from-[#062926] via-[#0A3D39] to-[#0C4742] border-r border-white/5 flex flex-col justify-between py-10 px-6 z-50 shadow-[inset_-1px_0_0_0_rgba(255,255,255,0.03),_6px_0_40px_rgba(0,0,0,0.2)]">
            ...
            <div className="border-t border-white/5 pt-6">
                ...
                >
                    <svg className="transition-transform duration-300 group-hover:translate-x-0.5" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
